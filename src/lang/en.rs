...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("confirm_idd_driver_tip", "The option to install the virtual display driver is checked. Note that a test certificate will be installed to trust the virtual display driver. This test certificate will only be used to trust HushDesk drivers."),
        ...
        ("enter_rustdesk_passwd_tip", "Enter HushDesk password"),
        ("remember_rustdesk_passwd_tip", "Remember HushDesk password"),
