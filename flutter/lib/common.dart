...
class MyTheme {
  ...
  static const Color accent = Color(0xFF06BA9E);
  static const Color accent50 = Color(0x7706BA9E);
  static const Color accent80 = Color(0xAA06BA9E);
  ...
  static const Color button = Color(0xFF038773);
...
String getWindowName({WindowType? overrideType}) {
  switch (overrideType ?? kWindowType) {
    ...
    case WindowType.FileTransfer:
      return "File Transfer - HushDesk";
    case WindowType.PortForward:
      return "Port Forward - HushDesk";
    case WindowType.RemoteDesktop:
      return "Remote Desktop - HushDesk";
    default:
      break;
  }
  return "HushDesk";
